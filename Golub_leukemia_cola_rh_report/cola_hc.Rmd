...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 134))', 'n_signatures \u2265 134', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 650))', 'n_signatures \u2265 650', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2054))', 'n_signatures \u2265 2054', prefix = 'collect-classes-from-hierarchical-partition')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 134))', 'n_signatures \u2265 134', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 650))', 'n_signatures \u2265 650', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2054))', 'n_signatures \u2265 2054', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 134),
    method = "UMAP", top_value_method = "ATC", top_n = 500, scale_rows = TRUE)', 'n_signatures \u2265 134', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 650),
    method = "UMAP", top_value_method = "SD", top_n = 500, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 650),
    method = "UMAP", top_value_method = "ATC", top_n = 500, scale_rows = TRUE)', 'n_signatures \u2265 650', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2054),
    method = "UMAP", top_value_method = "SD", top_n = 500, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2054),
    method = "UMAP", top_value_method = "ATC", top_n = 500, scale_rows = TRUE)', 'n_signatures \u2265 2054', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 134))', 'n_signatures \u2265 134', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 650))', 'n_signatures \u2265 650', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 2054))', 'n_signatures \u2265 2054', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 134))', 'n_signatures \u2265 134', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 650))', 'n_signatures \u2265 650', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 2054))', 'n_signatures \u2265 2054', prefix = 'test-to-known-factors-from-hierarchical-partition')
